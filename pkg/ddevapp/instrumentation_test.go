...
func TestSetInstrumentationAppTags(t *testing.T) {
	...
	for _, wanted := range []string{"database_type", "ProjectID", "performance_mode", "php_version", "router_http_port", "router_https_port", "router_status", "ssh_agent_status", "status", "type", "webimg", "webserver_type", "CI"} {
